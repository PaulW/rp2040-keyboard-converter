...
enum led_types {
    ...
    LED_RBG = 0x01,  // 0x01 /* RBG LED Type */
    LED_GRB = 0x02,  // 0x02 /* GRB LED Type */
    LED_GBR = 0x03,  // 0x03 /* GBR LED Type */
    LED_BRG = 0x04,  // 0x04 /* BRG LED Type */
    LED_BGR = 0x05,  // 0x05 /* BGR LED Type */
};
