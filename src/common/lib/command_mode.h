 ...
 * 4. Press 'B' to enter bootloader, 'D' to change log level, 'F' for factory reset, 'L' for LED brightness, or wait 3s for auto-exit
 * 5. If 'D' pressed: Press '1' (ERROR), '2' (INFO), or '3' (DEBUG) to set log level
 * 6. If 'L' pressed: Status LED cycles through rainbow colors, press '+'/'-' to adjust brightness (0-10)
