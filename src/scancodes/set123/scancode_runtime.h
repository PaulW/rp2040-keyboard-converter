 ...
 * | AB 85    | NCD N-97 or IBM 122-key Model M| Set 3 / Set 2 | NCD N-97 speaks Set 3  |
 ...
 */
#define SCANCODE_PROCESS_RUNTIME(code, config_ptr) \
    process_scancode((code), (config_ptr))
