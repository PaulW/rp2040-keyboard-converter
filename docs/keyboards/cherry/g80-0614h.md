...
The G80-0614H was used with British Telecom's telex terminal system. Custom key legends are specific for the terminal functions, and uses an XT-variant layout. Full NKRO capability with Cherry MX switches.
