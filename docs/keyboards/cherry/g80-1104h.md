...
The default keymap preserves the UK ISO layout whilst adding modern functionality through a second layer activated by holding Right Alt.
...
The BT Merlin Cheetah was British Telecom's rebrand of the STC TX3000S Telex Terminal, used in the late 1980s and early 1990s for telecommunications. The G80-1104H was the UK ISO-variant designed for this system—a 104-key layout that's similar to UK ISO but missing the extra key between Left Shift and Z. It uses the XT protocol with Scancode Set 1, has custom key legends for terminal functions, and was built with Cherry MX switches.
