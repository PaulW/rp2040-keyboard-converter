...
The G80-1104H was designed for British Telecom's telex terminal system. UK ISO-variant layout with 104 keys. Full NKRO capability with Cherry MX switches. Uses XT protocol with Scancode Set 1. Built for telecommunications use. Harder to find than standard PC keyboards due to specialised application.
