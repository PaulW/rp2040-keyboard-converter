...
The Cherry G80-1104H is a UK ISO layout terminal keyboard designed for the BT Merlin Cheetah Terminal—British Telecom's rebrand of the STC TX3000S Telex Terminal. It's got Cherry MX switches and uses the XT protocol with Scancode Set 1. This was one of Cherry's keyboards produced for OEM manufacturers in the late 1980s and early 1990s.
...
The default keymap preserves the UK ISO layout while adding modern functionality through the Fn modifier.
...
**Fn Modifier Key**: Right Alt (default, can be customized)
...
To customize the key layout, edit the keymap in [`keyboard.c`](../../../src/keyboards/cherry/G80-1104H/keyboard.c):
...
The G80-1104H was designed for British Telecom's telex terminal system. UK ISO-variant layout with 104 keys. Full NKRO capability with Cherry MX switches. Uses XT protocol with Scancode Set 1. Built for telecommunications use. Harder to find than standard PC keyboards due to specialized application.
...
Make sure your OS is set to "British PC" or "UK" keyboard layout for proper character mapping. Some keys will produce different characters than US layouts (£, @, ", etc.). You can customize [`keyboard.c`](../../../src/keyboards/cherry/G80-1104H/keyboard.c) if you need different character mappings.
