...
For macOS users, which lacks NumLock support, you could add a function layer to provide navigation key access. This would require editing [`keyboard.c`](../../../src/keyboards/microswitch/122st13/keyboard.c) to define additional layers and assign layer switching keys.
