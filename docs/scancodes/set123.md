...
The unified processor has a more complex state machine (11 states vs up to 9 for Set 2 alone), but introduces no runtime branching overhead beyond the configuration pointer.
