...
- Each command-response exchange is self-contained, but the keyboard retains protocol-level state across polls (for example, the Inquiry command reports key changes "since the last inquiry")
